...
public class CustomerRequestSO : ScriptableObject
{
    ...
    public bool useInlineMainDialogue;
    [Tooltip("인라인 대사 리스트 (DialogueLine)")]
    public List<DialogueLine> inlineMainDialogue = new List<DialogueLine>();
    [Tooltip("외부 DialogueData 에셋 참조")]
    public DialogueData referenceMainDialogue;

    [Header("=== Success Dialogue (거래 성공) ===")]
    [Tooltip("인라인 대사를 쓸 경우 체크")]
    public bool useInlineSuccessDialogue;
    public List<DialogueLine> inlineSuccessDialogue = new List<DialogueLine>();
    public DialogueData referenceSuccessDialogue;

    [Header("=== Failure Dialogue (거래 실패) ===")]
    [Tooltip("인라인 대사를 쓸 경우 체크")]
    public bool useInlineFailureDialogue;
    public List<DialogueLine> inlineFailureDialogue = new List<DialogueLine>();
    public DialogueData referenceFailureDialogue;
